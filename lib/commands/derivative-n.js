...
module.exports = new Definition(function (nths, expr) {
  ...
  if (!ed) {
    ...
    if (fn) {
      ...
      var res = derivativeWRT(fn.args()[1], fn.args()[0], nths.args()[0])
  ...
  if (ed === Power) {
    return powerDiff(nths)
  }
})

function powerDiff (nths) {
